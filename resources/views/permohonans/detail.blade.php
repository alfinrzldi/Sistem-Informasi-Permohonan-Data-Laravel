                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-header">
                            <h6 class="card-title mb-0 font-weight-bold">Detail Permohonan Berdasarkan Email</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($data->data)
                                                ...
                                                <a href="{{ Storage::url($data->data) }}" class="btn btn-success" download>Download File</a>
                                            @else
